...
cout<<".";
clrscr();
cout<<"The number in your mind is "<<ctr<<"."<<"\nDo you want to know the logic behind this game?";
ch=getch();
if (ch=='Y' || ch=='y')
	{
	cout<<"As you know, every decimal number can be represneted by the sum of powers of 2.\nFollowing the very same logic, we divide all the numbers from 1 to 100 into the sum of powers of 2.\nEx- "<<ctr<<" = "<<"can be expressed as the sum of the first digits of boxes it is present in.";
	cout<<"Taking another example, cosider number 19. It can be expressed as 2^4 + 2^1 + 2^0. Therefore, it is put in boxes starting with 16 (2^4), 2 (2^1) and 1 (2^0).";
	cout<<"Similarly we split numbers from 1 to 100 as sum of powers of 2 and put them in box that start with power of 2 which the number is split into.\n This way, whenever you say that a number is present in your box, the program adds the first term. \n\nThe total sum of all first terms ends up representing your number.\n Try the game again. Observe the logic.";
	getch();
	}
else
	{
